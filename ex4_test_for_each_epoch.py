...
def train(train_loader, validation_loader, test_loader):
...
def test(model, test_loader, epoch):
    model.eval()
    with open ("test_y_" + str(epoch), "w") as file:
...
if __name__ == '__main__':
    ...
    train(train_loader, validation_loader, test_loader)
